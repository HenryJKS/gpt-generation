        ...
        >
            ...
            <div>
                <TextArea
                    ...
                    rows={10}
                    style={{
                        width: "100%", padding: "1%", borderRadius: "5px", marginBottom: "1%",
                        backgroundColor: "rgba(255, 255, 255, 0.45)", color: "black", fontSize: "1.0em",
                ...
                />
                <div>
                    <Button onClick={handleClickService} disabled={isWriting}>Atendimento Cliente</Button>
